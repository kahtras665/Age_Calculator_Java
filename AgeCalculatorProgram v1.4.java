 ...
 *  11.November-     30 days
 *  12.December-     31 days */
// v1.4 (added a new feature which finds out the number of days remaining for the next Birthday of the user) [to check the add-ons, proceed to line number 593]
...
class timecalculator
{
    public static void main(String args[])
    {
        ...
        System.out.println("");
        System.out.print("Do you want to know the number of days left for your next birthday: Y/N?");
        char nxtB= obj.next().charAt(0);
        int res=0, bd=0;
        if(nxtB!='y' && nxtB!='Y' && nxtB!='N' && nxtB!='n')
        {
            System.out.print("Follow the instructions carefully (Re-enter either Y or N): ");
            nxtB= obj.next().charAt(0);
        }
        if(nxtB=='y' || nxtB=='Y')
        {
            if (monthCurrent<monthBirth)
            {
                for(int k=monthCurrent; k<=monthBirth; k++)
                {
                    if(k==monthCurrent)
                    {
                        if(monthCurrent==4 || monthCurrent==6 || monthCurrent==9 || monthCurrent==11)
                            res= 30-dateCurrent;
                        if(monthCurrent==1 || monthCurrent==3 || monthCurrent==5 || monthCurrent==7 || monthCurrent==8 || monthCurrent==10 || monthCurrent==12)
                            res= 31-dateCurrent;
                        if(monthCurrent==2)
                            res= 28-dateBirth;
                    }
            ...
            System.out.println(bd+" days are left for your next birthday!");
        }
    if(nxtB=='N' || nxtB=='n')
            System.out.println("Ok then :(  I thought you were excited to know!");
        System.out.println("");
