 ...
 *  11.November-     30 days
 *  12.December-     31 days */
 // errors are there as it says "Wrong Input! Enter date correctly"
...
class timecalculator
{
    public static void main(String args[])
    {
        ...
        if(fin1=='y' || fin1=='Y')
            System.out.println("You are "+year+" years and "+month+" months, "+name+".");
        else
        ...
        if (ans=='Y' || ans=='y')
          ...
          System.out.println("Follow the instructions carefully (enter either Y or N)");
        System.out.println("");
